...
Start with player 1, then move to the next player to the right. Repeat until only one player has any money. That remaining player wins the pot in the center. 
## Build
	$ make
## Running
	$ ./lrc
